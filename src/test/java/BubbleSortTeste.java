...
public class BubbleSortTeste {
    ...
    public void melhorCasoDezMilTeste() {
        int[] vetor = ordenador.bubbleSort(vetorDezMilOrdenado);
    }

    @Test
    public void medioCasoDezMilTeste() {
        int[] vetor = ordenador.bubbleSort(vetorDezMilAleatorio);
    }

    @Test
    public void piorCasoDezMilTeste() {
        int[] vetor = ordenador.bubbleSort(vetorDezMilOrdemInversa);
    }

    @Test
    public void melhorCasoCemMilTeste() {
        int[] vetor = ordenador.bubbleSort(vetorCemMilOrdenado);
    }

    @Test
    public void medioCasoCemMilTeste() {
        int[] vetor = ordenador.bubbleSort(vetorCemMilAleatorio);
    }

    @Test
    public void piorCasoCemMilTeste() {
        int[] vetor = ordenador.bubbleSort(vetorCemMilOrdemInversa);
    }

    @Test
    public void melhorCasoUmMilhaoTeste() {
        int[] vetor = ordenador.bubbleSort(vetorUmMilhaoOrdenado);
    }

    @Test
    public void medioCasoUmMilhaoTeste() {
        int[] vetor = ordenador.bubbleSort(vetorUmMilhaoAleatorio);
    }

    @Test
    public void piorCasoUmMilhaoTeste() {
        int[] vetor = ordenador.bubbleSort(vetorUmMilhaoOrdemInversa);
    }
